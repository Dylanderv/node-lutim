...
var LUTIM_API_URL = 'https://lut.im/';
...
lutim.getServerInfos = function () {
  ...
  lutim._requestBuilder('serverInfos')
    .then(function (json) {
...
lutim.uploadImage = function (file, deleteDay, firstView, keepExif, crypt) {
  ...
  lutim._requestBuilder('upload', null, params)
    .then(function (json) {
      deferred.resolve(json);
    })
    .catch(function (err) {
...
lutim.deleteImage = function (realShort, token) {
  ...
  lutim._requestBuilder('delete', payload)
    .then(function (json) {
      deferred.resolve(json);
    })
    .catch(function (err) {
 ...
 * @param {string} realShort - image identifier
 * @param {string} token
 * @param {int} deleteDay - number of days you want the image to stay
 * @param {int=} firstView - if not 0, the image will be deleted at first view (default: 0)
 * @returns {promise}
 */
lutim.modifyImage = function (realShort, token, deleteDay, firstView) {
  ...
  lutim._requestBuilder('modify', payload, params)
    .then(function (json) {
      deferred.resolve(json);
    })
    .catch(function (err) {
...
lutim.getImage = function (short) {
  ...
  lutim._requestBuilder('getImage', short)
    .then(function (json) {
      deferred.resolve(json);
    })
    .catch(function (err) {
 ...
 * @link https://framagit.org/fiat-tux/hat-softwares/lutim/wikis/API
 * @param {string} real_short - image identifier
 * @returns {promise}
 */
lutim.getImageInfos = function (real_short) {
  var deferred = Q.defer();

  if (typeof real_short !== 'string' || real_short && real_short.length === 0) {
    deferred.reject(new Error('Invalid short'));
    return deferred.promise;
  }

  lutim._requestBuilder('imageInfos', real_short)
    .then(function (json) {
      deferred.resolve(json);
    })
    .catch(function (err) {
...
lutim.getImageCountAndStatus = function (short, token) {
  ...
  lutim._requestBuilder('imageCountStatus', null, params)
    .then(function (json) {
      deferred.resolve(json);
    })
    .catch(function (err) {
